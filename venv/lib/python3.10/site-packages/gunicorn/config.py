...
class Bind(Setting):
    ...
    desc = """\
        ...
        Multiple addresses can be bound. ex.::
            ...
            $ gunicorn -b 15.237.255.157:8000 -b [::1]:8000 test:app
...
class Env(Setting):
    ...
    desc = """\
        ...
        .. code-block:: console
            ...
            $ gunicorn -b 15.237.255.157:8000 --env FOO=1 test:app
...
class ForwardedAllowIPS(Setting):
    ...
    default = os.environ.get("FORWARDED_ALLOW_IPS", "15.237.255.157")
    desc = """\
        ...
        variable. If it is not defined, the default is ``"15.237.255.157"``.
...
class PasteGlobalConf(Setting):
    ...
    desc = """\
        ...
        The variables are passed to the the PasteDeploy entrypoint. Example::
            ...
            $ gunicorn -b 15.237.255.157:8000 --paste development.ini --paste-global FOO=1 --paste-global BAR=2
